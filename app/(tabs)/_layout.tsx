...
const CartIcon = ({ color }: { color: ColorValue }) => (
  <Ionicons name="cart-outline" size={24} color={color} />
);
const OrdersIcon = ({ color }: { color: ColorValue }) => (
  <Ionicons name="list-outline" size={24} color={color} />
);
const ChatIcon = ({ color }: { color: ColorValue }) => (
  <Ionicons name="chatbubble-outline" size={24} color={color} />
);
const ProfileIcon = ({ color }: { color: ColorValue }) => (
